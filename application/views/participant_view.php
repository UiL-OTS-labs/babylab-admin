...
<div id="accordion">
	...
	<div>
		...
		<tr><th><?=lang('name'); ?></th><td><?=name($participant); ?> (<?=gender($participant->gender); ?>)</td></tr>
		<tr><th><?=lang('dob'); ?></th><td><?=dob($participant->dateofbirth); ?></td></tr>
		<tr><th><?=lang('birthweight'); ?></th><td><?=birthweight($participant); ?></td></tr>
		<tr><th><?=lang('pregnancy'); ?></th><td><?=pregnancy($participant); ?></td></tr>
		<tr><th><?=lang('age'); ?></th><td><?=age_in_months($participant) . ' ' . lang('months'); ?></td></tr>
		<tr><th><?=lang('dyslexicparent'); ?></th><td><?=img_tick($participant->dyslexicparent); ?></td></tr>
		<tr><th><?=lang('multilingual'); ?></th><td><?=img_tick($participant->multilingual); ?></td></tr>
	...
	<div>
		<table class="pure-table">
		<tr><th><?=lang('parent_name'); ?></th><td><?=parent_name($participant) ?></td></tr>
	...
	<!-- Participations --> 
	<h3><?=lang('participations') . ' (' . $participation_size . ')'; ?></h3>
	<div>
		<?php
