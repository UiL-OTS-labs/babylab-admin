...
<div>
	...
	<tr><th><?=lang('participant'); ?></th><td><?=participant_get_link($participant); ?></td></tr>
	<tr><th><?=lang('experiment'); ?></th><td><?=experiment_get_link($experiment); ?></td></tr>
	<tr><th><?=lang('risk_group'); ?></th><td><?=$participation->risk ? lang('yes') : lang('no'); ?></td></tr>
	<tr><th><?=lang('last_called'); ?></th><td><?=output_datetime($participation->lastcalled); ?></td></tr>
	<tr><th><?=lang('status'); ?></th><td><?=lang($participation->status); ?></td></tr>
	<tr><th><?=lang('comment'); ?></th><td><?=$participation->comment; ?></td></tr>
