...
Wanneer uw kind benedengemiddeld scoort is er lang niet altijd reden tot zorg: kinderen ontwikkelen zich niet in een rechte lijn en het kan daarom heel goed zo zijn dat er van de lage scores niets meer te zien is bij een volgende meting. Wanneer dat wel zo is en de scores zijn erg laag, bij meerdere metingen, dan is het verstandig om contact op te nemen met <?=BABYLAB_MANAGER; ?> (<?=mailto(BABYLAB_MANAGER_EMAIL); ?>)
