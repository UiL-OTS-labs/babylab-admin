...
<p>Een deel van het onderzoek bestaat uit het in verband brengen van de taak waarvoor u met <?=$name_first; ?> bent gekomen en <?=$gender_pos; ?> de ontwikkeling van <?=$name_first; ?> op verschillende momenten.</p>
...
<p>De link naar de vragenlijst (<em>Anamnese</em>) vindt u hier: <?=$survey_link; ?>.</p>
