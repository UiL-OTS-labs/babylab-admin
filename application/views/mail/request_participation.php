...
<p>Op dit moment komt <?=$name_first; ?> in aanmerking om deel te nemen aan een lopend onderzoek. 
In de bijlage vindt u een korte beschrijving van het onderzoek <em><?=$description; ?></em>, alsmede over onze werkwijze. </p>
<p>Wij zouden u willen vragen een e-mail terug te sturen aan ons, zodat wij weten of u met <?=$name_first; ?> deel wilt nemen of niet.</p>
