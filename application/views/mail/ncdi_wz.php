...
<p>Een deel van het onderzoek bestaat uit het in verband brengen van de taak waarvoor u met naam kind bent gekomen en <?=$gender_pos; ?> de taalvaardigheid van <?=$name_first; ?> op drie verschillende momenten. 
...
<p>Mocht u vragen hebben n.a.v. de vragenlijst of de interpretatie daarvan, dan kunt u contact opnemen met <?=BABYLAB_MANAGER; ?>: <?=BABYLAB_MANAGER_PHONE; ?> of mailen naar: <a href="mailto:babylabutrecht@uu.nl">babylabutrecht@uu.nl</a>.</p>
