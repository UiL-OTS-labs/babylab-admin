...
<div>
	...
	<table class="pure-table">
		<tr><th><?=lang('name'); ?></th><td><?=$testcat->name; ?></td></tr>
		<tr><th><?=lang('code'); ?></th><td><?=$testcat->code; ?></td></tr>
		<tr><th><?=lang('test'); ?></th><td><?=test_get_link($test) ?></td></tr>
		<?php if (!$is_parent) { ?>
			<tr><th><?=lang('boxplot'); ?></th><td><?=testcat_score_boxplot($testcat->id); ?></td></tr>
			<tr><th><?=lang('parent_testcat'); ?></th><td><?=testcat_get_link($parent_testcat); ?></td></tr>
		<?php } ?>
	</table> 
