...
<tr><th><?=lang('user'); ?></th><td><?=$user->username; ?> (<em><?=lang($user->role); ?></em>)</td></tr>
<tr><th><?=lang('phone'); ?></th><td><?=$user->phone; ?></td></tr>
<tr><th><?=lang('mobile'); ?></th><td><?=$user->mobile; ?></td></tr>
<tr><th><?=lang('email'); ?></th><td><?=mailto($user->email); ?></td></tr>
<tr><th><?=lang('preferredlanguage'); ?></th><td><?=lang(user_language($user)); ?></td></tr>
</table>
