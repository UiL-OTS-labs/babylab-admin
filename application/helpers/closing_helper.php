...
if (!function_exists('closing_actions'))
{
	...
	{
		$edit = anchor('closing/edit/' . $closing_id, img_edit());
		$delete = anchor('closing/delete/' . $closing_id, img_delete(), warning(lang('sure_delete_closing')));
		return implode(' ', array($edit, $delete));
	}
}
